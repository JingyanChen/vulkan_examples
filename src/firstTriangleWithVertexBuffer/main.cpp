...
vulkanShader* vs = new vulkanShader("../src/firstTriangleWithVertexBuffer/meta/vs.spv", VK_SHADER_STAGE_VERTEX_BIT);
vulkanShader* ps = new vulkanShader("../src/firstTriangleWithVertexBuffer/meta/ps.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
