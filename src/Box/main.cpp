...
vulkanShader* vs = new vulkanShader("../src/Box/meta/vs.spv", VK_SHADER_STAGE_VERTEX_BIT);
vulkanShader* ps = new vulkanShader("../src/Box/meta/ps.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
...
void createTextureImage() {
    ...
    stbi_uc* pixels = stbi_load("../src/Box/texture/box.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
