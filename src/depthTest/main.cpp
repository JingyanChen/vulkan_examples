...
vulkanShader* vs = new vulkanShader("../src/depthTest/meta/vs.spv", VK_SHADER_STAGE_VERTEX_BIT);
vulkanShader* ps = new vulkanShader("../src/depthTest/meta/ps.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
